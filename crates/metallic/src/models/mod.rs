...
use crate::{Context, TensorElement, gguf::model_loader::GGUFModel};
...
pub fn load<L: LoadableModel<T>, T: TensorElement>(gguf_model: &GGUFModel, ctx: &mut Context<T>) -> Result<L, MetalError> {
