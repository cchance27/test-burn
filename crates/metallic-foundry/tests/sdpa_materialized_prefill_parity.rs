...
use metallic_foundry::{
    Foundry, MetalError, metals::sdpa::step::SdpaMaterializedStep, spec::{Step, TensorBindings}, storage::Pooled, tensor::{F16, Tensor as FoundryTensor, TensorInit}, types::TensorArg
};
...
fn test_sdpa_materialized_prefill_parity_m4() -> Result<(), MetalError> {
    ...
    let sdpa_step = SdpaMaterializedStep {
        ...
        output: "out".into(),
        causal: false,
        query_offset: metallic_foundry::spec::DynamicValue::Literal(0),
        n_heads: metallic_foundry::spec::DynamicValue::Literal(n_heads as u32),
        head_dim: metallic_foundry::spec::DynamicValue::Literal(head_dim as u32),
        kv_seq_len: metallic_foundry::spec::DynamicValue::Literal(kv_seq_len as u32),
        m: metallic_foundry::spec::DynamicValue::Literal(m as u32),
        kv_head_major: true,
    };
