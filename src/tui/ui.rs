...
pub fn render(app: &mut App, frame: &mut Frame) {
    ...
    let text_visible_lines = text_area_layout[0].height.saturating_sub(2) as u16; // Subtract 2 for borders
    ...
    if total_visual_lines > text_visible_lines && text_visible_lines > 0 {
        ...
        let max_scroll = (total_visual_lines - text_visible_lines).max(0) as usize;
...
fn create_text_with_selection(text: &str, app: &App, area: Rect) -> ratatui::text::Text<'static> {
