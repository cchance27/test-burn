...
instantiate_gemm_transpose_helper(f32, float, f32, float, 8, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(f32, float, f32, float, 4, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(f32, float, f32, float, 1, 32, 16, 1, 1)
...
instantiate_gemm_transpose_helper(f16, half, f16, half, 8, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(f16, half, f16, half, 4, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(f16, half, f16, half, 1, 32, 16, 1, 1)
...
instantiate_gemm_transpose_helper(bf16, bfloat, bf16, bfloat, 8, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(bf16, bfloat, bf16, bfloat, 4, 32, 16, 1, 2)
instantiate_gemm_transpose_helper(bf16, bfloat, bf16, bfloat, 1, 32, 16, 1, 1)
#endif
