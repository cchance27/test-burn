...
For macro details, see `docs-in-progress/MACROS.md`.
...
- `crates/metallic/src/metals/matmul_gemv/simd_common.metal`
...
**Quant/policy code**
- `crates/metallic/src/metals/policies/simd_gemv_*_canonical.metal`
...
- `crates/metallic/src/metals/matmul_gemv/fused/swiglu.rs`
- `crates/metallic/src/metals/matmul_gemv/fused/qkv.rs`
