// MLX kernel variant derived from original_mlx.metal, tuned with deeper BK=64 tiles
// for improved throughput on large-K matmuls.
// Source lineage: https://github.com/ml-explore/mlx/blob/main/mlx/backend/metal/kernels/steel/gemm
...
instantiate_gemm_transpose_helper(f16, half, f16, half, 32, 32, 64, 2, 2)
instantiate_gemm_transpose_helper(f16, half, f16, half, 16, 64, 64, 1, 4)
instantiate_gemm_transpose_helper(f16, half, f16, half, 64, 16, 64, 4, 1)
...
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 32, 32, 64, 2, 2)
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 16, 64, 64, 1, 4)
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 64, 16, 64, 4, 1)
