// MLX kernel variant derived from original_mlx.metal (commit preserved locally).
// Tweaked for M=1 matmuls with deeper K tiles (BK=64) to reduce threadgroup churn.
// Based on original MLX Steel GEMM:
...
// Specialised f16 kernel for M=1 workloads with deeper K tiles.
instantiate_gemm_transpose_helper(f16, half, f16, half, 8, 128, 64, 1, 4)
...
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 8, 128, 64, 1, 4)
