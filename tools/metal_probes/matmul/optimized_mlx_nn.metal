// MLX kernel variant derived from original_mlx.metal.
// Specialises for NN (transpose_b = false) matmuls with wider N tiles.
// Upstream source: https://github.com/ml-explore/mlx/blob/main/mlx/backend/metal/kernels/steel/gemm
...
instantiate_gemm_transpose_helper(f16, half, f16, half, 32, 64, 32, 2, 2)
instantiate_gemm_transpose_helper(f16, half, f16, half, 16, 128, 32, 1, 4)
...
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 32, 64, 32, 2, 2)
instantiate_gemm_bias_transpose_helper(f16, half, f16, half, 16, 128, 32, 1, 4)
