...
Skipping compilation for m1_dot_product_v2.metal (hash match)
Skipping compilation for m1_dot_product_v3.metal (hash match)
Skipping compilation for m1_dot_product_v4.metal (hash match)
Skipping compilation for m1_dot_product_v5.metal (hash match)
Skipping compilation for m1_dot_product_v6.metal (hash match)
Skipping compilation for m1_dot_product_v7.metal (hash match)
Skipping compilation for m1_dot_product.metal (hash match)
Skipping compilation for optimized_mlx_bk64.metal (hash match)
Skipping compilation for optimized_mlx_m1.metal (hash match)
Skipping compilation for optimized_mlx_nn.metal (hash match)
Skipping compilation for original_gemm_tiled.metal (hash match)
Skipping compilation for original_gemv_smalln.metal (hash match)
Skipping compilation for original_gemv.metal (hash match)
Skipping compilation for original_mlx.metal (hash match)
